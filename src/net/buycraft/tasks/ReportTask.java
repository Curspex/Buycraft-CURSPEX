...
public class ReportTask extends ApiTask {
	...
	private static final String googleAddress = "www.google.com",
								apiAddress = "api.buycraft.net",
								isGdAddress = "www.is.gd",
								apiAccessPath = "http://" + apiAddress + "/ok.php";
	...
	public void run()
	{
		try
		{
			...
			String date = new Date().toString(),
				   ...
				   buycraftVersion = Plugin.getInstance().getVersion();
			...
			String pingGoogle = pingCheck(googleAddress),
				   pingApi = pingCheck(apiAddress),
				   isGdCheck = pingCheck(isGdAddress),
				   serviceCheck = checkOkay();
